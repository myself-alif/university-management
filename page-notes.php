...
<div class="container container--narrow page-section">
    ...
    <div class="create-note">
        ...
        <textarea class="new-note-body" name="" id="" placeholder="type note here"></textarea>
        <span class="submit-note">Create note</span>
        <span class="note-limit-message">You have reached not limit. Please delete previous posts to be able to create
            new ones.</span>
    </div>
    ...
    <ul class="min-list link-list" id="my-notes">
        ...
        <li data-id="<?php echo get_the_id() ?>">
            ...
            <textarea readonly class="note-body-field" name=""
                id=""><?php echo esc_html(wp_strip_all_tags(get_the_content())) ?></textarea>
